                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-grid">
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                                <form class="kt-form" id="kt_user_add_form" novalidate="novalidate" action="{{url('categories')}}" method="post">
                                    @csrf
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="kt-section__body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control" type="text" value="{{old('details')}}" name="details">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control" type="text" value="{{old('unit')}}" name="unit">
                                                                    @if ($errors->has('unit'))
