                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-grid">
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                                <form class="kt-form" id="kt_user_add_form" novalidate="novalidate" action="{{url("customers/{$customer->id}")}}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                                        <div class="kt-heading kt-heading--md">Customer:</div>
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="kt-section__body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control" type="date" value="{{$customer->dob}}" name="dob">
                                                                    @if ($errors->has('dob'))
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <select name="sex" class="form-control">
                                                                        ...
                                                                        <option {{$customer->sex == 0 ? 'selected' : '' }} value="0">Male</option>
                                                                        <option {{$customer->sex == 1 ? 'selected' : '' }} value="1">Female</option>
                                                                    </select>
                                                                    @if ($errors->has('sex'))
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <select name="is_active" class="form-control">
                                                                        <option value="">Please select one</option>
                                                                        <option {{$customer->is_active == 0 ? 'selected' : '' }} value="0">Inactive</option>
                                                                        <option {{$customer->is_active == 1 ? 'selected' : '' }} value="1">Active</option>
                                                                    </select>
