        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                ...
                <div class="kt-subheader__toolbar">
                    ...
                    <a href="{{ url('supplies/create') }}" class="btn btn-label-brand btn-bold">Create supply
                    </a>
                </div>
            </div>
        </div>
                        ...
                        @if ($supplies->first())
                            @foreach ($supplies as $supply)
                                <tr>
                                    ...
                                    <td class="d-flex">
{{--                                        <a href="{{url("supplies/{$supply->id}/edit")}}" title="Edit" class="btn btn-sm btn-clean btn-icon btn-icon-md">--}}
{{--                                            <i class="la la-edit"></i></a>--}}
                                        <form action="{{url("supplies/{$supply->id}")}}" onsubmit="return confirm('Do you really want to delete?');" method="post">
                                            @csrf
                                            @method('DELETE')
