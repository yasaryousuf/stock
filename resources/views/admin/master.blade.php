...
<head>
    ...
    <link href="{{asset('metronic/theme/default/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}"
          rel="stylesheet" type="text/css"/>
    <link href="{{asset('metronic/theme/default/demo1/dist/assets/css/pages/wizard/wizard-4.css')}}"
          rel="stylesheet" type="text/css"/>
    ...
    <link href="{{asset('metronic/theme/default/demo1/dist/assets/css/skins/header/base/light.css')}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset('metronic/theme/default/demo1/dist/assets/css/skins/header/menu/light.css')}}" rel="stylesheet"
          type="text/css"/>
...
<script src="{{asset('metronic/theme/default/demo1/dist/assets/js/scripts.bundle.js')}}"
        type="text/javascript"></script>

<script src="{{asset('metronic/theme/default/demo1/dist/assets/js/pages/components/extended/toastr.js')}}"
        type="text/javascript"></script>
<script src="{{asset('metronic/theme/default/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"
        type="text/javascript"></script>
...
<script src="{{asset('metronic/theme/default/demo1/dist/assets/plugins/custom/gmaps/gmaps.js')}}"
        type="text/javascript"></script>
<script src="{{asset('metronic/theme/default/demo1/dist/assets/js/pages/dashboard.js')}}"
        type="text/javascript"></script>
@yield('script')
</body>
</html>
