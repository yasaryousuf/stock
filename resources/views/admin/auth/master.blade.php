...
<div class="kt-grid kt-grid--ver kt-grid--root">
    <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v1" id="kt_login">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
            <div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside" style="background-image: url({{url('metronic/theme/default/demo1/dist/assets/media/bg/bg-4.jpg')}});">
                <div class="kt-grid__item">
                    <a href="{{url('/')}}" class="kt-login__logo">
                        <img src="{{url('/metronic/theme/default/demo1/dist/assets/media/logos/logo-4.png')}}">
                    </a>
                </div>
