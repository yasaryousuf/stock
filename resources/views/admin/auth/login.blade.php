...
@section('content')
    <div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
        <div class="kt-login__head">
            ...
            <a href="{{url('registration')}}" class="kt-link kt-login__signup-link">Sign Up!</a>
        </div>
        <div class="kt-login__body">
            <div class="kt-login__form">
                ...
                <form class="kt-form" action="{{url('login')}}" novalidate="novalidate" id="kt_login_form" method="post">
                    @csrf
                    ...
                    <div class="kt-login__actions">
                        <a href="{{url('forgot-password')}}" class="kt-link kt-login__link-forgot">
                            Forgot Password ?
                        </a>
